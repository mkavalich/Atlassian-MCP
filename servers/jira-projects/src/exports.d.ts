/**
 * Jira Projects MCP Server - Type Declarations
 *
...
export declare function registerProjectTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
export declare function registerIssueTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
export declare function registerIssueTypeTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
export declare function registerDashboardTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
export declare function registerReportingTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
export declare function registerAttachmentTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
