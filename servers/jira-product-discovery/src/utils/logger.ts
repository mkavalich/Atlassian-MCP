...
export const logger = winston.createLogger({
  ...
  defaultMeta: { service: 'jira-product-discovery-mcp-server' },
  transports: [
...
export function logGraphQLCall(operationName: string, statusCode?: number, duration?: number) {
  logger.info('GraphQL Call', {
    operationName,
    statusCode,
    duration,
  });
