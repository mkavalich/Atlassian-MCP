...
// Org-level Audit Logging & Compliance Monitoring schemas
export const getOrgAuditEventsSchema = z.object({
...
export const getOrgAuditEventsStreamSchema = z.object({
  orgId: z.string().describe('The organization ID'),
  startDate: z.string().optional().describe('Start date for audit events (ISO 8601 format)'),
  endDate: z.string().optional().describe('End date for audit events (ISO 8601 format)'),
  eventType: z.string().optional().describe('Filter by specific event type'),
...
export const getOrgSecurityPoliciesSchema = z.object({
  orgId: z.string().describe('The organization ID'),
...
export const getOrgSecurityPolicySchema = z.object({
  orgId: z.string().describe('The organization ID'),
  policyId: z.string().describe('The specific policy ID to retrieve'),
}).strict();

export const getOrgAuthPoliciesSchema = z.object({
  orgId: z.string().describe('The organization ID'),
...
export const getOrgClassificationLevelsSchema = z.object({
  orgId: z.string().describe('The organization ID'),
  includeInactive: z.boolean().optional().default(false)
    .describe('Include inactive classification levels'),
}).strict();

export const getOrgClassificationLevelSchema = z.object({
  orgId: z.string().describe('The organization ID'),
...
// API Usage & Security Monitoring schemas
export const getOrgApiTokensSchema = z.object({
...
export const getOrgApiTokensCountSchema = z.object({
...
export const getOrgApiKeysSchema = z.object({
...
export const getOrgApiKeysCountSchema = z.object({
