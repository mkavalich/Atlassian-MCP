/**
 * Jira Service Desk MCP Server - Type Declarations
 *
...
export declare function registerServiceDeskTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
export declare function registerCustomerOrganizationTools(server: McpServer, apiClient: JiraApiClient): Promise<void>;
